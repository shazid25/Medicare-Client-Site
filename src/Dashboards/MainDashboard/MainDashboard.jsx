    ...
    <div className="flex h-screen bg-gray-100">
      ...
      `}>
        ...
        <nav className="p-4 flex-1 overflow-y-auto">
          <ul className="space-y-2">
            <NavigationItems onItemClick={closeMobileMenu} />
          </ul>
        </nav>
        ...
        <div className="p-4 border-t border-blue-700">
          <button
            ...
            className="flex items-center w-full p-3 rounded-lg hover:bg-blue-700 transition-colors text-red-200 hover:text-white"
          >
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="lg:hidden bg-white shadow-sm border-b p-4 flex items-center justify-between">
          ...
          <div className="w-10">
            {/* User profile icon or placeholder */}
