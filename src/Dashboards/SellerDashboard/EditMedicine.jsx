...
// const EditMedicineForm = ({ currentUser }) => {
//   const { id } = useParams();
...
//         sellerEmail: currentUser.email, // ✅ FIXED: Changed from 'email' to 'sellerEmail'
//       };
...
//       navigate("/manage-seller-medicines");
//     } catch (err) {
//       console.error(err);
...
//                 <button
//                   type="button"
//                   onClick={() => navigate("/manage-seller-medicines")}
