...
//       id: 1,
//       name: 'Cardiology',
//       icon: <FaHeartbeat size={40} className="text-red-500 animate-float" />,
//       products: '126 products',
//     },
//     {
//       id: 2,
//       name: 'Diabetes',
//       icon: <FaPills size={40} className="text-blue-500 animate-float" />,
//       products: '89 products',
//     },
//     {
//       id: 3,
//       name: 'Respiratory',
//       icon: <FaLungs size={40} className="text-teal-500 animate-float" />,
//       products: '74 products',
//     },
//     {
//       id: 4,
//       name: 'Vitamins',
//       icon: <FaCapsules size={40} className="text-yellow-500 animate-float" />,
//       products: '215 products',
//     },
//     {
//       id: 5,
//       name: 'Neurology',
//       icon: <FaBrain size={40} className="text-purple-500 animate-float" />,
//       products: '64 products',
//     },
//     {
//       id: 6,
//       name: 'Orthopedics',
//       icon: <FaBone size={40} className="text-indigo-500 animate-float" />,
